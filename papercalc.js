...
const Alkalanity = new Calc("Alkalinity", "Burette Reading", "Normality of Hcl", "Sample Volume", "", "", "",
  "ml", "N", "ml", "", "", "ppm", `Alkalanity is the capacity  of water to  resist changes in pH that would make water more acidic.
   ...
   pink now titrate it with 0.1 N HCl by adding HCl drop by drop till pink color disappears. </br> 
   <img src= "https://upload.wikimedia.org/wikipedia/commons/8/8c/Titolazione.gif"> </br> (Image source Wikipedia)
...
const Acidity = new Calc("Acidity", "Burette Reading", "Normality of NaOH", "Sample Volume", "", "", "", "ml", "N", "ml", "", "",
 ...
 flask add few drops of phenolphthalin or methyl orange indicator and titrate with 0.5N NaOH solution till colour of
  solution changes to pink.</br> </br>Formula for calculation of Acidity =  A*N*50000/Sample Volume, where A is beurette reading and N is normality of Alkali solution.`,
...
const Ash_retention = new Calc("First Pass Ash Retention", "H/B Ash", "B/W Ash", "", "", "", "", "%", "%", "", "", "", "%",
 ...
 sample and then calculate Ash retention  as per formula given above. </br>Unretained furnish components like fillers,fibers and additives can create collection,disposal 
...
const Automatic_control = {name:'Automatic Process Control',definition:` To achieve a certain level of economy,safety 
and consistency  of operations almost all continuous process plants use some kind of automatic process control method.
...
</br> ( Example of level control system image source Wikipedia.)</br> </br>  In the example above a controller compares level of tank
as given by sensor with set point and then based on error  send signal to  a valve to keep the level at set point.
...
const BOD = new Calc("BOD", "Initial DO", "Final DO", "fraction of sample used  for titration", "", "", "", "mg/l", "mg/l",
 ...
 decomposition of dissolved organic matter under aerobic condition usually at 20 degree centigrade in 5 days.</Br>Biochemical\
  oxygen demand is an important water quality parameter because it provides an index to assess the effect, discharged\
   wastewater will   have on the receiving  environment.</br> Depletion of DO causes stress on aquatic organisms, making the environment\
    unsuitable for life.</Br> </br> BOD is similar to COD . However BOD is more specific since it measures organic matter that can be oxidised\
...
strength in kN/m and R is paper gsm. </br>  <strong> Test method: </strong> </br> First paper sample is cut in
 pieces of 25 mm wide and then clamped in Tensile testing machine.</br> The machine is then started
...
const brightness_whiteness_shade = {
 ...
 reflectance of blue light  of wavelength 457nm.</br>Tappi standard and ISO standards are commonly used for brightness\
  ...
  two types of paper with the same brightness can visually appear very different, even though their “brightness” is the same.\
     ...
     perception.</br> The most common whiteness measure, D65 illumination, represents outdoor daylight.</br> This standard is called CIE Whiteness and was developed by the French-based International Commission on Illumination \
     (also abbreviated CIE).  </br> </br>Shade is measurement of  color of paper.</br>  CIE L*a*b model is used for color measurement.\
 </br> L value is a measure of lightness along black white axis,a value is measure of red/ green and b value is a measure of blue/yellow. "}
//burst factor
...
required to rupture the sample by constantly increasing the pressure applied through a rubber diaphgram on 30.5 mm diameter sample. \
 ...
 strength and toughness.</br> It is useful in packaging grades of paper where paper is subjected to a stress similar to that exerted in Burst test.\
 </br>After every 100 readings equipment is calibrated using aluminum foil and after every 500 readings  or six months whichever is earlier \
 diaphragm  is replaced. </br></br> <strong> Test Method:</strong>  </br> First condition paper at 27 degree centigrade and
 65% Relative humidity . Place the sample over diaphgram and clamp it. Start the equipment and record pressure at 
 which paper ruptured. </br>Calculate BF as per formula given above. `}
...
of a sized paper by exposing  paper surface to fixed amount of water for a certain period usually 45 sec.</br> <strong> Test Method:</strong>\
...
var change_in_crown = new Calc("Change in crown of two rolls", "Nip width at ends", "Nip width at center",
  "Top roll diameter", "Bottom roll diameter", "", "", "mm", "mm", "mm", "mm", "", "mm", "Roll crowning is common method to reduce nip variations\
 caused by roll deflection. Roll crowning is calculated from Nip impression or deflection of roll. " )
...
const Paper_defects = {
 ...
 like holes,cracks,spots etc,then frequency is observed. If defects are appearing continuously then it is a likely a problem of machine\
 pumps rolls,wire,felt etc.</br> If  defects are appering occasionally then it could be a problem of additives preparation system. Following are most\
 common defects. </br> <b> Air Bubbles: </b>  Caused by too much water in paper. </br> <b> Bursts: </b> Bursts in a reel are caused\
 by high web  tension between rolls during winding. </br>  <b> Blistering: </b> It is caused when water vapour 
 can not escape  fast enough through coating layers. </br> <b> Calander mark: </b>  It is caused by some extrenous material present in nips or \
 faulty calander surfaces.  </br> <b> Cockling: </b> Paper has wave like pattern. </br> <b> Crush: </b> It is caused by too much\
 pressure or moisture in press section. </br> <b> Dandy Mark: </B> caused by fibers picking by Dandy roll from wet web. </br> \
 ...
 holes are also caused by dirt and slimes.</br> <b> Pin holes: </b> Pin holes are small holese caused by foreign particles.\
...
the entire plant.</br> It is a computerised control system  with many control loops and controllers distributed throughout 
...
//Pump basics
const Pump_basic = {
  name: 'Pump Basics', definition: `A pump can be defined as a machine that increases the total energy of a liquid
   this means that pump transfers mechanical energy to a fluid  and converts it to pressure energy of fluid.</br>
    Generally pumps are of two types Centrifugal pump and positive displacement pumps.</br></br> Centrifugal pumps are suitable for low pressure high liquid flow rate application
...
priming whereas PD pumps do not require priming.</Br></br>All pumps have three parts</br> 1. Suction </br>2.Pump casing
 </br> 3. Delivery.</br> </br> In centrifugal pumps pump casing contains an impeller which rotates at very high rpm 
 and increases the kinetic energy of liquid in the outer side of pump casing,this creates a partial vacuum at the 
 center of casing and fluid is sucked in through suction pipe.The increased kinetic energy in converted to pressure 
 in the oulet pipe of pump. </br></br><img src="https://upload.wikimedia.org/wikipedia/commons/4/4a/Centrifugal_Pump.png" alt="Centrifugal Pump.png" height = "250px" width = "250px">
</br> (Centrifugal Pump image source Wikipedia) </br></br> In Positive displacement pump, there are two valves one on
suction side and one on delivery side.The pump casing has a mechanism to suck liquid from suction side and deliver to 
delivery side,the mechanism is different in reciprocating PD pump and rotating PD pump.</br> </br>
  In reciprocating pump 
the mechanism include one cylinder and piston connected to motor by a connecting rod.</br> In one cycle the piston 
movement create  suction pressure and liquid is sucked in. </br> In  other cycle movement  the piston  compress 
the liquid and  the is discharged through delivery pipe. </Br> </br>
...
</br> (Progressive Cavity pump image source Wikipedia) </br> ` }
...
is not very useful because of its oscillatory natue. </br>To contol the output to a desired setpoint three control actions are
...
beacause feedback controller works only on the error and if there is no error it will not work.</br> To reduce this steady state
error integral action is required. Proportional and integral actions create oscillations in the system, to make the systen
stable derivative action is used . </br>In PID controller we have all these three control actions.PID controller maintains the output such 
that there is zero error between the process variable and setpoint/ desired output by closed-loop operations. </br>
<a title="Arturo Urquizo, CC BY-SA 3.0 &lt;https://creativecommons.org/licenses/by-sa/3.0&gt;, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:PID_en.svg"><img width="512" alt="PID en" src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/PID_en.svg/512px-PID_en.svg.png"></a>
 </br> (Working of  PID Controller Image source Wikipedia)</br>  </br> <b>Tuning Of controller: </b> </br> There are several methods to set proportional
 integral and derivates gains.(K</sub>p</sub>, K</sub>i</sub> and K</sub>d</sub>). </br>
 Manual setting and Zeigller method are  common method to set controler parameters. In manual method first K</sub>p</sub> is set keeping derivative and integral constants
 ...
 ( PID Controller tuning image source Wikipedia) </br> </br>` 
 }
...
</br> PLC are generally programmed in ladder logic and C language. `}
calc.push(PLC)
// Porosity
const Porosity = {
...
var pH_of_Solution = {
 ...
 a solution is 7 at 25 degree celcius it will be slightly less than 7 at higher temperature. "  }
...
var R_chlorine = new Calc("Residual Chlorine", "Burette Reading", "Normality of Sodium Thiosulphate", "Sample Volume", "", "", "", "ml", "N", "g", "",
  "", "ppm", `Residual chlorine is low amount of chlorine left in pulp  after washing of pulp.\
    </br>It is measured by titrating sample  with  Sodium thiosulphate using starch iodine titration method until color changes.   \
     ...
     sample in a beaker add 5 ml acetic acid + 1-2 g KI powder.</br>  Colour of sample will become yellow and then titrate with sodium thiosulphate
...
const Total_active_effective_alkali = new Calc("Total active and effective alkali", "Buerette Reading", "Normality of Hcl",
  ...
  titrate immediately with  with Hcl using thymolphthalin indictor to pH 9.5 note the reading as<b> a </b>.</break>
   Then add formaldehyde  to convert hydrogen sulphide to   strong base and  continue titration   to pH 8.0 using
  phenolphthalin indicator.</br> Note the reading as <b> b </b>.</br> Finally total  alkali is determined by continuing titration to pH 
  ...
  a= HCl consumed using thymopthaline indicator. </br> b is consumption of HCl using phenolphthalin indicator.</Br>
   c is consumption of HCl using bromophenol indicator. </b> </br> m is molar concentration of HCl </br> v is volume of 
...
const Smoothness = {
 ...
 measuring head on test piece </br> Note down the reading of rotameter after 5 sec of placing of measuring head.  `}
...
const Tensile = new Calc("Tensile Index", "Tensile Strength", "Basis Weight", "", "", "", "", "N/m", "g/m2", "", "", "", "Nm/g",
 ...
 and paperboard . </br> Generally tensile strength of materials is expressed in terms of load per unit area but in case of paper\
